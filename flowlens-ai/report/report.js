...
function render(report) {
    ...
    if (footer) {
        var modeLabel = report.mode === 'ai' ? 'AI-Powered Analysis' : 'Deterministic UX Analysis';
        var footerText = 'Generated by FlowLens AI \u00B7 ' + modeLabel;
        if (report.apiError) {
            footerText += ' \u00B7 ' + esc(report.apiError);
        }
